        ...
        <div className="bg-black/30 border border-gray-700 p-6 rounded-xl shadow-inner space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <select
              ...
              className="p-3 rounded-lg bg-gray-800/70 border border-gray-600 text-white focus:ring-2 focus:ring-blue-500"
            >
            ...
            <label className="flex items-center gap-2">
              <input
                ...
                checked={form.participation_choice || false}
                onChange={handleChange}
            ...
            <input type="number" name="battle_rating" placeholder="Battle Rating" value={form.battle_rating || ''} onChange={handleChange} className="p-3 rounded-lg bg-gray-800/70 border border-gray-600 text-white focus:ring-2 focus:ring-blue-500"/>
            <input type="number" name="kills" placeholder="Kills" value={form.kills || ''} onChange={handleChange} className="p-3 rounded-lg bg-gray-800/70 border border-gray-600 text-white focus:ring-2 focus:ring-blue-500"/>
            <input type="number" name="deaths" placeholder="Deaths" value={form.deaths || ''} onChange={handleChange} className="p-3 rounded-lg bg-gray-800/70 border border-gray-600 text-white focus:ring-2 focus:ring-blue-500"/>
          </div>
